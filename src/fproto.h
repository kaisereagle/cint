...
void G__gen_setgvp G__P((int pushpop));
void G__gen_addstros_x G__P((int addstros,char* file,int line));
#define G__gen_addstros(x) G__gen_addstros_x(x,__FILE__,__LINE__)
#else
