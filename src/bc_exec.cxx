...
extern "C" int G__bc_exec_virtualbase_bytecode(G__value *result7
  ...
  long vtblindex = hash&0xffff; // virtual function table index
  long vbasetagnum = hash/0x10000; // vbasetagnum
  long voffset=G__struct.virtual_offset[vtagnum]; // offset for true tagnum info
  long tagnum = *(long*)(G__store_struct_offset+voffset); // tagnum of object
          //            A
  ...
  long offset = vtbldata->GetOffset();
