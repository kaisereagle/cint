...
int G__preprocessormode G__P((int mode));
int G__getpreprocessormode G__P(());
#endif
...
#ifndef G__OLDIMPLEMENTATION4001
/**************************************************************************
* SETGVP
**************************************************************************/
void G__gen_setgvp(int pushpop) {
#ifdef G__ASM_DBG
...
******************************************************************/
#ifndef G__OLDIMPLEMENTATION4001
void G__gen_addstros_x(addstros,file,line)
int addstros;
char* file;
int line;
{
...
#ifdef G__ASM_DBG
    if(G__asm_dbg) 
      G__fprinterr(G__serr,"%3x: ADDSTROS %d (func 1 %s %d)\n" ,G__asm_cp,addstros,file,line);
#endif
...
#ifdef G__ASM_DBG
    if(G__asm_dbg) 
      G__fprinterr(G__serr,"%3x: ADDSTROS %d (func 1)\n" ,G__asm_cp,addstros);
#endif
    G__asm_inst[G__asm_cp]=G__ADDSTROS;
    G__asm_inst[G__asm_cp+1]=addstros;
    G__inc_cp_asm(2,0);
...
int memfunc_flag;
{
  ...
  if(ig15<lenitem) {
	...
	if(1==castflag) {
      ...
      ig15++;
      result7[ig35]='\0';
      if(ig35<G__ONELINE) { /* THIS MUST BE IT!!! */
	strcpy(fpara.parameter[fpara.paran],result7);
      }
      else {
	strcpy(fpara.parameter[fpara.paran],"@");
...
int hash;
{
  ...
  *********************************************************************/
  ...
  if(strcmp(funcname,"G__dasm")==0) {
    if(G__no_exec_compile) return(1);
    /* pause */
    G__letint(result7,'i',(long)G__dasm((FILE*)G__int(libp->para[0]),G__int(libp->para[1])));
    return(1);
  }
  ...
  if(strcmp(funcname,"G__preprocessormode")==0) {
    if(G__no_exec_compile) return(1);
    G__letint(result7,'i',(long)G__preprocessormode((int)G__int(libp->para[0])));
    return(1);
  }
  if(strcmp(funcname,"G__getpreprocessormode")==0) {
    if(G__no_exec_compile) return(1);
    G__letint(result7,'i',(long)G__getpreprocessormode());
    return(1);
  }
...
/******************************************************************
* G__getpreprocessormode()
******************************************************************/
int G__getpreprocessormode()
{
  return(G__cpp);
}
