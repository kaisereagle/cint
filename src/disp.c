...
int tagnum;
{
   ...
   if (tagnum) {} /* just to avoid unused parameter warning */
#endif
  /* to be implemented */
}
...
* void G__disp_detail
***********************************************************************/
int G__disp_detail_flag=0;
int G__disp_detail() { return(G__disp_detail_flag); }
void G__set_disp_detail(flag)
     int flag;
{ G__disp_detail_flag=flag; }
...
{
#ifndef G__OLDIMPLEMENTATION1911
   if (msg) {} /* just to avoid unused parameter warning */
#endif
}
