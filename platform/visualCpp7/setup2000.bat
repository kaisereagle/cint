echo off
REM ###########################################################################
REM # platform\visualCpp7\setup2000.bat
REM #
...
REM # BUILD MAKECINT
cd %CINTSYSDIR%\platform\visualCpp7\tool\makecint
...
move %CINTSYSDIR%\platform\visualCpp7\tool\makecint\Release\makecint.exe %CINTSYSDIR%\makecint.exe
