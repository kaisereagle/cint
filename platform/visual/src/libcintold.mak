...
LINK32_FLAGS=kernel32.lib user32.lib /nologo /subsystem:windows /dll\
 /incremental:no /pdb:"$(OUTDIR)/libcint.pdb" /machine:I386 /def:".\libcint.def"\
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /Zi /Od /I "..\..\..\cint" /I "..\..\src" /I "..\..\lib\vcstream" /I "..\..\lib\stdstrct" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "G__VISUAL" /D "G__WIN32" /D "G__SHAREDLIB" /D "G__REDIRECTIO" /D "G__P2FCAST" /D "G__ASM_DBG" /YX /c
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /I "..\..\..\cint" /I "..\..\src" /I\
 "..\..\lib\vcstream" /I "..\..\lib\stdstrct" /D "_DEBUG" /D "WIN32" /D\
 "_WINDOWS" /D "G__VISUAL" /D "G__WIN32" /D "G__SHAREDLIB" /D "G__REDIRECTIO" /D\
 "G__P2FCAST" /D "G__ASM_DBG" /Fp"$(INTDIR)/libcint.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib /nologo /subsystem:windows /dll\
 ...
 /def:".\libcint.def" /out:"$(OUTDIR)/libcint.dll"\
...
"$(INTDIR)\APIIFOLD.OBJ" : $(SOURCE) $(DEP_CPP_APIIF) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\VCSTRMOLD.OBJ" : $(SOURCE) $(DEP_CPP_VCSTR) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
