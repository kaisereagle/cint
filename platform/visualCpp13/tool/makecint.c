 ...
 * into Cint as Dynamic Link Library for Windows-NT Visual C++ 13.0.
 ************************************************************************
...
FILE *fp;
{
 ...
 fprintf(fp,"!IF  \"$(CFG)\" == \"Release\"\n");
#else
 //fprintf(fp,"CFG=%s - Win32 Release\n",G__DLLID);
 fprintf(fp,"!IF  \"$(CFG)\" == \"%s - Win32 Release\"\n",G__DLLID);
#endif
 fprintf(fp,"LIB = \\\n");
 fprintf(fp,"   \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\msvcprt.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\MSVCRT.lib\" \\\n");
 //fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\LIBCMT.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\OLDNAMES.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v7.1A\\Lib\\Uuid.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v7.1A\\Lib\\Kernel32.lib\" \n");
 fprintf(fp,"!ELSE\n");
 fprintf(fp,"LIB = \\\n");
 fprintf(fp,"   \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\msvcprtd.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\MSVCRTd.lib\" \\\n");
 //fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\LIBCMT.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\lib\\OLDNAMES.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v7.1A\\Lib\\Uuid.lib\" \\\n");
 fprintf(fp,"  \"C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v7.1A\\Lib\\Kernel32.lib\" \n");
 ...
 fprintf(fp,"  /I \"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\VC\\include\" \\\n");
 fprintf(fp,"  /I \"C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v7.1A\\Include\" \\\n");
 fprintf(fp,"\n");
...
#endif
 fprintf(fp,"\n");
 fprintf(fp,"MACROCINT      = -D __VC13__ ");
...
G__outputmakefile() {
 ...
 fprintf(fp,"# Microsoft Developer Studio Generated NMAKE File, Format Version 13.00\n");
 ...
 fprintf(fp,"CFG=%s - Win32 Release\n",G__DLLID);
#endif
 fprintf(fp,"!MESSAGE No configuration specified.  Defaulting to %s - Win32 Release.\n",G__DLLID);
 fprintf(fp,"!ENDIF \n");
 fprintf(fp,"\n");
 ...
 fprintf(fp,"!MESSAGE \n");
#ifdef NEWFLAG
 fprintf(fp,"!MESSAGE NMAKE /f \"%s.mak\" CFG=\"Debug\"\n",G__DLLID);
#else
 ...
 fprintf(fp,"\n");
 fprintf(fp,"CPP_PROJ=/nologo /ML /W3 /EHsc /D __VC13__ /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D \"NDEBUG\" /D\\\n");
 ...
 fprintf(fp,"\n");
#ifdef DIRECT
 fprintf(fp,"\"%s.exe\" : \"$(OUTDIR)\" $(DEF_FILE) $(LINK32_OBJS)\n",G__DLLID);
#else
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"CPP_PROJ=/nologo /MLd /W3 /Gm /EHsc /D __VC13__ /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D\\\n");
...
G__outputmakefiledll() {
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"CPP_PROJ=/nologo /MD /W3 /EHsc -D __VC13__ /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D \"NDEBUG\" /D\\\n");
 fprintf(fp," \"WIN32\" /D \"_WINDOWS\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\"\\\n");
 fprintf(fp," /Fp\"$(INTDIR)/%s.pch\" /Fo\"$(INTDIR)/\" /c $(IPATH) $(MACRO)\n",G__DLLID);
 fprintf(fp,"CPP_OBJS=.\\Release/\n");
 fprintf(fp,"CPP_SBRS=\n");
...
#ifdef DIRECT
 fprintf(fp," /machine:I386 /def:\".\\%s.def\" /out:\"%s.dll\" /implib:\"$(OUTDIR)/%s.lib\" \n",G__DLLID,G__DLLID,G__DLLID);
#else
 ...
 fprintf(fp,"\n");
#ifdef DIRECT
 fprintf(fp,"\"%s.dll\" : \"$(OUTDIR)\" $(DEF_FILE) $(LINK32_OBJS)\n",G__DLLID);
#else
 ...
 fprintf(fp,"<<\n");
#ifndef DIRECT
 fprintf(fp,"   copy \"$(OUTDIR)\\%s.dll\" %s.dll\n",G__DLLID,G__DLLID);
#endif
 fprintf(fp,"\n");
 fprintf(fp,"!ELSEIF  \"$(CFG)\" == \"%s - Win32 Debug\"\n",G__DLLID);
 fprintf(fp,"\n");
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"CPP_PROJ=/nologo /MDd /W3 /Gm /EHsc -D __VC13__ /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D\\\n");
 fprintf(fp," \"_DEBUG\" /D \"WIN32\" /D \"_WINDOWS\" /D \"G__VISUAL\" /D \"G__WIN32\" /D\\\n");
 fprintf(fp," \"G__SHAREDLIB\" /Fp\"$(INTDIR)/%s.pch\" /Fo\"$(INTDIR)/\" /Fd\"$(INTDIR)/\"\\\n",G__DLLID);
 fprintf(fp," /c $(IPATH) $(MACRO)\n");
 fprintf(fp,"CPP_OBJS=.\\Debug/\n");
 fprintf(fp,"CPP_SBRS=\n");
...
void G__outputmakebat()
{
  ...
  fprintf(fp,"\n");
#ifdef NEWFLAG
  fprintf(fp,"nmake CFG=\"Release\" %%1 %%2 %%3 %%4 %%5 %%6\n");
#else
