...
void makeit() {
  ...
  sprintf(com,"%s\\cint.exe makeit.c",cintsysdir);
  docommand(com);
}

/***********************************************************************/
int main(int argc,char** argv) {
  char *platform = "visualCpp13";
  ...
  buildlib("lib\\ReadF");
  buildlib("lib\\EasyExp");
  buildlib("lib\\NVector");
  buildlib("lib\\CSV");
  buildlib("lib\\Kmeans_EM_VB_FCM"); // need Eigen library
  buildlib("tool\\ifdef");
