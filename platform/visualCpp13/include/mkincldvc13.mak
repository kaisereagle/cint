...
CPP_PROJ=/nologo  /w /W0 /EHsc /D __VC13__ $(IPATH) /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" \
 /Fp"$(INTDIR)/mkincld.pch" /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
CPP_PROJ=/nologo  /w /W0 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D\
 "_CONSOLE" /Fp"$(INTDIR)/mkincld.pch" /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
