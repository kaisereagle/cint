...
HEADERS		= ..\..\..\..\SC\INCLUDE\stdio.h ..\..\..\..\SC\INCLUDE\stdlib.h ..\..\..\..\SC\INCLUDE\string.h 

DEFFILE		= makecint.DEF
...
CFLAGS		=  -j0 -mn -o+time -WA -3 -a8 -c -w- -w2 
...
!IF EXIST (MAKECINT.dpd)
!INCLUDE MAKECINT.dpd
!ENDIF
