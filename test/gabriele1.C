...
void drift_velocity(double x, double y, double& vx, double& vy) {
  ...
  switch (model) 
	...
	+0.102912*(x-0.1 )/(pow(x-0.1 ,2)+pow(y+1,2)));
      ...
      ey = -(
	-0.086354*(y-1.0)/(pow(x+0.1 ,2)+pow(y-1,2))
	-0.066419*(y-1.0)/(pow(x     ,2)+pow(y-1,2))
	-0.086354*(y-1.0)/(pow(x-0.1 ,2)+pow(y-1,2))
	
	-0.012136*(y    )/(pow(x+0.08,2)+pow(y,  2))
	-0.009957*(y    )/(pow(x+0.06,2)+pow(y,  2))
	-0.009957*(y    )/(pow(x-0.06,2)+pow(y,  2))
	-0.012136*(y    )/(pow(x-0.08,2)+pow(y,  2))
	
	+0.102912*(y+1.0)/(pow(x+0.1 ,2)+pow(y+1,2))
	+0.078810*(y+1.0)/(pow(x,     2)+pow(y+1,2))
	+0.102912*(y+1.0)/(pow(x-0.1 ,2)+pow(y+1,2)));
      vx = -mu * ex; 
      vy = -mu * ey;
      break;
