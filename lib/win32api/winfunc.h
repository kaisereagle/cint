...
//BOOL GetFileTime(HANDLE hFile, LPFILETIME lpftCreation, LPFILETIME lpftLastAccess, FILETIME *lpftLastWrite);
#pragma link C func GetFileTime;

BOOL SetFileTime(HANDLE hFile, const FILETIME *lpftCreation, const FILETIME *lpftLastAccess,
...
//BOOL LocalFileTimeToFileTime(const LPFILETIME lpLocalFileTime, LPFILETIME lpFileTime);
#pragma link C func LocalFileTimeToFileTime;

//BOOL FileTimeToLocalFileTime(const LPFILETIME lpFileTime, LPFILETIME lpLocalFileTime);
...
#pragma link C func GetCurrentProcess;

BOOL SetPriorityClass(HANDLE hProcess, DWORD dwPriorityClass);
#pragma link C func SetPriorityClass;

DWORD GetPriorityClass(HANDLE hProcess);
#pragma link C func GetPriorityClass;
