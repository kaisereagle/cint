...
#pragma link C++ class map<long,string>;
#pragma link C++ class map<double,string>;
...
#pragma link C++ class map<long,const char*>;
...
#pragma link C++ class map<double,const char*>;
...
#pragma link off function pair<const long,const char*>::operator=;
...
#pragma link off function pair<const double,const char*>::operator=;
#endif
...
#pragma link C++ class map<char*,const char*>;
