...
int S_ISSOCK(mode_t m); 
#endif
#if (defined(G__APPLE) || defined(__APPLE__)) && (G__GNUC_VER<4000) && (__GNUC__<4)
...
#elif (defined(G__APPLE) || defined(__APPLE__)) && (G__GNUC_VER<4000) && (__GNUC__<4)
...
#define G__PROCESSPRIORITY
#ifdef G__PROCESSPRIORITY
#ifdef __APPLE__
extern int getpriority(int whitch,id_t who);
extern int setpriority(int whitch,id_t who,int prio);
#else
extern int getpriority(int whitch,int who);
extern int setpriority(int whitch,int who,int prio);
#endif
#endif
