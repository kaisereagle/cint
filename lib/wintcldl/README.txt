...
environment using Visual C++ 4.0. Compilation environment for Symantec C++
7.2 is obsoleted (just because IMPORTS statement in WILDC.DEF file is 
incomplete now).

 For Tcl/Tk8.3 version, go to /lib/wintcldl83.
...
What you need:=============================================================
 ...
 What you need to run WildCard are
    ...
    + Tcl7.5/Tk4.1 
    + cint revision 5.11.32 or later
...
Compile: ==================================================================
 ...
 2) Install Tcl7.5/Tk4.1.
   You need to get Tcl7.5/Tk4.1 or later. It can be get from Sun-Microsystem's
  ftp site. This package is a self-extracting archive. Use file manager to 
  run the package, then setup program will start. Please install it to C:\TCL
  directory (this is the default).

          ftp://ftp.smli.com/pub/tcl/win41p1.exe

 3) Run C:\CINT\LIB\WINTCLDL\setup.bat
   Run SETUP.BAT from DOS prompt.

 4) Adding path
   Edit C:\AUTOEXEC.BAT using notepad or other text editor. Please add 
  following lines at the end.

   SET PATH=%PATH%;C:\CINT\LIB\WINTCLDL;C:\TCL\BIN
